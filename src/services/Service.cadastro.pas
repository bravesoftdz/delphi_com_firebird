...
type
  TServiceCadastro = class(TDataModule)
    ...
    QRY_cadCaixaFOR_DESCRICAO: TStringField;
    ...
    QRY_receber1PES_RAZAO: TStringField;
    procedure QRY_produto1AfterScroll(DataSet: TDataSet);
    procedure QRY_movestoqueAfterScroll(DataSet: TDataSet);
    procedure QRY_movestoqueitemReconcileError(DataSet: TFDDataSet; E: EFDException; UpdateKind: TFDDatSRowState;
...
procedure TServiceCadastro.QRY_movestoqueitemReconcileError(DataSet: TFDDataSet; E: EFDException;
...
begin  // pegando as parcelas do receber
